...
$(".side-toggel-menu").click(function () {
    isTrue ? ($(".nav-tab-menu").addClass("open-menu").removeClass("close-menu"), nvWidth = $(".nav-tab-menu").width() - 10, $(".side-header-nav").css("left", nvWidth), $(".fa-align-justify").toggleClass("fa-times"), $(".nav-tab-menu .item1").animate({
        opacity: "1",
        paddingTop: "25px"
        ...
        opacity: "1",
        paddingTop: "25px"
    }, 1600), isTrue = !isTrue) : ($(".nav-tab-menu").addClass("close-menu").removeClass("open-menu"), $(".fa-align-justify").toggleClass("fa-times"), $(".side-header-nav").css("left", 0), $(".nav-tab-menu li").animate({
        opacity: "0",
        paddingTop: "500px"
    }, 500), isTrue = !isTrue)
});
...
function displayCategories() {
    ...
    <div class="col-md-6 col-lg-3 my-3 media-style shadow">
        <div class="country-recipe shadow rounded position-relative">
...
function displayIngredients() {
    ...
    for (var i = 0; i < arr.length; i++) e += `
    <div class="col-md-6 col-lg-3 my-3 media-style  shadow">
        <div onclick="getMainIngredient('${arr[i].strIngredient}')" class="country-recipe shadow rounded position-relative">
            <div class="post ">
...
function displayMeals(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        meals += `
        <div class="col-md-6 col-lg-3 my-3 media-style  shadow">
            <div onclick="getMeal('${arr[i].idMeal}')" class="country-recipe shadow rounded position-relative">
                <div class="post ">
...
function displayMeal(meal) {
    ...
    <div class="col-md-4 media-style text-white">
				...
				<div class="col-md-8 media-style text-white text-left">
					<h2>Instructions</h2>
...
$(".nav-item a").click(async (e) => {
    ...
    if (listBy == "contact") {
        ...
        row.innerHTML = `
        <section id="contact" class="container media-style w-75 mx-auto mb-5 ">
		<div class="p-2">
			<h2 class="text-danger mb-5">Contact Us</h2>
			<div class="row py-4">
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="alert mt-1 alert-danger d-none" id="emailalert" role="alert">
							Enter valid email. *Ex: xxx@yyy.com
						</div>
					</div>
				</div>
				<div class="col-md-6">
    ...
    document.querySelector('.side-toggel-menu').dispatchEvent(click_event);
...
$(document).scroll((e) => {
    ...
    if ($(document).scrollTop()) {
        $(".main-style").css("backgroundColor", "#0D0D0D")
    }
})
